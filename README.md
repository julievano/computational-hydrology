...
*   migrate to https://github.com/NCAR/computational-hydrology instead? (would match https://ral.ucar.edu/hap/computational-hydrology)
*   link w/ ral perm link (once migration finished), Roy may share more at meeting tomorrow 
*   mock up several options for front page 
*   add RAL logo w/ address at bottom
*   get Andy N. and Naoki to contribute (test it out)
...
*   Get sponsor category to be centered
